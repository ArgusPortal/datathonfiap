...
class TestSchemaValidation:
    ...
    def test_pii_field_rejected(self, valid_inference_data):
        ...
        assert (
            "pii" in str(exc_info.value).lower() or "ra" in str(exc_info.value).lower()
        )
    ...
    def test_nome_pii_rejected(self, valid_inference_data):
        ...
        assert (
            "pii" in str(exc_info.value).lower()
            or "nome" in str(exc_info.value).lower()
        )
    ...
    def test_missing_target_in_training(self, valid_inference_data):
        ...
        assert (
            ...
            or "em_risco" in str(exc_info.value).lower()
        )
    ...
    def test_invalid_target_values(self, valid_training_data):
        ...
        assert (
            "target" in str(exc_info.value).lower()
            or "binário" in str(exc_info.value).lower()
        )
    ...
    def test_empty_batch(self):
        ...
        assert (
            "vazio" in str(exc_info.value).lower()
